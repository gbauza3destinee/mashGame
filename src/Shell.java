...
public class Shell {
    ...
    /**
     * Owns the UI for the MASH app. Provides command-line interface
    ...
    private static final String PARTNER_NAME_ID_PROMPT =
            "Please enter Partner Name Entry 1";
    private static final String NUMOFKIDS_NAME_ID_PROMPT =
     ...
     */
    public Shell(PartnerName partnerName, ATAUserHandler userHandler) {
